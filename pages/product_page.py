...
class ProductPage(BasePage):
    def add_to_basket(self):
        ...
        # готовим переменные для того, чтобы потом в тесте проверить, совпадает ли имя и цена помещенного в корзину товара, указанное в выскакивающем алерте, с именем товара, который мы добавляли
        ...
        self.item_name_in_alert_message = self.browser.find_element(
            *ProductPageLocators.NAME_OF_ITEM_ADDED_TO_BASKET_IN_ALERT_MESSAGE).text
        ...
        self.amount_of_basket_in_alert_message = self.browser.find_element(
            *ProductPageLocators.BASKET_AMOUNT_IN_ALERT_MESSAGE).text
    ...
    #     return self.browser.find_element(*ProductPageLocators.NAME_OF_ITEM_ADDED_TO_BASKET_IN_ALERT_MESSAGE).text
    #
    # def get_amount_of_basket_in_alert_message(self):
    #     return self.browser.find_element(*ProductPageLocators.BASKET_AMOUNT_IN_ALERT_MESSAGE).text